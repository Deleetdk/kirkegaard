...
test_that("wtd_sum", {
  ...
  expect_true(throws_error(wtd_sum(NA, error = T)))
  expect_equal(wtd_sum(NA, error = F), NA)
})
...
test_that("wtd_mean", {
  ...
  expect_true(throws_error(wtd_mean(NA, error = T)))
  expect_equal(wtd_mean(NA, error = F), NA)
})
...
test_that("wtd_sd", {
  ...
  expect_true(throws_error(wtd_sd(NA, error = T)))
  expect_equal(wtd_sd(NA, error = F), NA)
})
