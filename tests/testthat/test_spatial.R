...
#lag it
us_states_lagged = add_spatial_knn(us_states, vars = c("Income", "Illiteracy", "Life Exp"))

#try other names
us_states_lagged2 = add_spatial_knn(us_states %>% select(-lat, -lon), vars = c("Income", "Illiteracy", "Life Exp"), lon = "x", lat = "y")

test_that("add_spatial_knn", {
  #seems right
